const Download = () => {
    return (
      <div style={{ flex: 1,height:"100vh", color: "#fff",  display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center", padding: "20px", width:"52%", marginLeft:"45%", marginTop:"-70%",backgroundColor:"#222E35",position:"adsolute",}}>
